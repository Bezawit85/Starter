...
const Login = () => {
  ...
  return (
    ...
    <div className="max-w-md w-full space-y-8 bg-white">
        <div>
      <h1 className="mt-6 text-center text-2xl text-gray-900">Enter your credentials</h1>
      </div>
      ...
      <input type="hidden" name="remember" value="true" />
        ...
        <button className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm
         font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 mb-6" type="submit">Login</button>
      </div>
      </form>
